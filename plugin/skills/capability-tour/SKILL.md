...
3. `Available portable skills`: list `hello-world`, `skill-a`, `skill-b`, `capability-tour`, `new-note`, `new-project`, `runtime-custody`, and `ultragoal`, marking the first three Bun-backed and the last five model-only.
